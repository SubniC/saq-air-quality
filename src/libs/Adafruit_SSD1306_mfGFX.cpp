...
void Adafruit_SSD1306::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color) {
  ...
  switch(rotation) {
    case 0:
      ...
      break;
    case 1:
      // 90 degree rotation, swap_adafruit x & y for rotation, then invert x
      bSwap = true;
      swap_adafruit(x, y);
      x = WIDTH - x - 1;
      break;
    case 2:
      ...
      break;
    case 3:
      // 270 degree rotation, swap_adafruit x & y for rotation, then invert y  and adjust y for w (not to become h)
      bSwap = true;
      swap_adafruit(x, y);
      y = HEIGHT - y - 1;
      y -= (w-1);
...
void Adafruit_SSD1306::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color) {
  ...
  switch(rotation) {
    case 0:
      break;
    case 1:
      // 90 degree rotation, swap_adafruit x & y for rotation, then invert x and adjust x for h (now to become w)
      bSwap = true;
      swap_adafruit(x, y);
      x = WIDTH - x - 1;
      x -= (h-1);
    ...
    case 2:
      ...
      break;
    case 3:
      // 270 degree rotation, swap_adafruit x & y for rotation, then invert y
      bSwap = true;
      swap_adafruit(x, y);
      y = HEIGHT - y - 1;
      break;

...
void begin(byte iPin, const char * iSongBuffer)
{
  ...
  DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] Playing: %s", iSongBuffer);
  #endif
  ...
  noteDelay = 0;
  #ifdef RTTTL_NONBLOCKING_DEBUG
  DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] noteDelay=%lu", noteDelay);
  #endif
  ...
  DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] ddur: %d", default_dur);
  #endif
  ...
  #ifdef RTTTL_NONBLOCKING_INFO
    DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] doct: %d", default_oct);
  #endif
  ...
  #ifdef RTTTL_NONBLOCKING_INFO
      DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] bpm: %d", bpm);
  #endif
  ...
  #ifdef RTTTL_NONBLOCKING_INFO
        DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] wn: %d", bwholenotepm);
  #endif
}
...
void nextnote()
{
  ...
  {
    #ifdef RTTTL_NONBLOCKING_INFO
      DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] Playing: %d %d (%d) %d", scale, note, notes[(scale - 4) * 12 + note], duration);
    #endif
  ...
  {
    #ifdef RTTTL_NONBLOCKING_INFO
          DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] Pausing: %d", duration);
    #endif
...
void play()
{
  ...
  {
    #ifdef RTTTL_NONBLOCKING_DEBUG
          DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] done playing...");
    #endif
  ...
  {
    #ifdef RTTTL_NONBLOCKING_DEBUG
              DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] still playing a note...");
    #endif
  ...
  if (*buffer == '\0')
  {
    ...
    #ifdef RTTTL_NONBLOCKING_DEBUG
              DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] end of note...");
    #endif
  ...
  else
  {
    ...
    #ifdef RTTTL_NONBLOCKING_DEBUG
              DBG_TAG("DEBUG", "[RTTTL_NONBLOCKING] next note...");
    #endif

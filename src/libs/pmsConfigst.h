...
// Without PMS_DYNAMIC:
//   con: PmsSensor related object should be defined as global variable (C style): PmsSensor pms;
...
// With PMS_DYNAMIC:
//   pro: PmsSensor related object instance should be created (C++ style) using _pms = new PmsSensor();

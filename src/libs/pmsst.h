...
private:
	...
	jb::logic::tribool passive;
	jb::logic::tribool sleep;
...
public:
	...
	//en photon no tenemos __uint24, eso es de AVR-GCC
	//https://forum.arduino.cc/index.php?topic=430492.0
